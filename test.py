...
try:
    usernameInput = WebDriverWait(driver, 10).until(
        EC1.presence_of_element_located((By.NAME, "username"))
    )
...
try:
    passwordInput = WebDriverWait(driver, 10).until(
        EC1.presence_of_element_located((By.NAME, "password"))
    )
finally:
...
try:
    query = WebDriverWait(driver, 10).until(
        EC1.presence_of_element_located((By.XPATH, "/html/body/div[3]/div[2]/div[1]/div[3]/form/label"))
    )
    time.sleep(2)
finally:
...
try:
    chartButton = WebDriverWait(driver, 10).until(
        EC1.presence_of_element_located((By.XPATH, "//*[@id='js-category-content']/div/div/div/div/div[1]/div/div[1]/div/a"))
    )
